stockFlow — MERN Stock Trading Platform
...
Test the App
Register — Create an account (starts with ₹1,00,000 balance)
Market — Browse 20 stocks with live simulated prices
Stock Detail — Click any stock to see the 30-day chart
Buy — Purchase shares; balance is deducted instantly
Portfolio — Track holdings and P&L
Watchlist — Star stocks to track them
Sell — Sell shares to realize gains/losses
History — View full transaction log
Team Members
Name	Role
